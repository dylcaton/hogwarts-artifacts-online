...
class ArtifactControllerTest {
    ...
    void setUp() {
        ...
        a3.setDescription("The Elder Wand, known throughout history as the Deathstick or the Wan");
        ...
        a4.setDescription("A magical map of Hogwarts created by Remus Lupin, Peter Pettigrew, Si");
        ...
        a6.setDescription("The Resurrection Stone allows the holder to bring back deceased loved");
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        //when and then
        this.mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/artifacts/1250808601744904192").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testDeleteArtifactSuccess() throws Exception {
        ...
        //when and then
        this.mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/artifacts/1250808601744904191").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
